// CashSync marketing seed — 架空ユーザー「タロー」。APIのみ経由（本名は一切使わない）。PORT=3013。
...
console.log("サマリ 収入合計:", sum.summary?.incomeTotal, "支出合計:", sum.summary?.expenseTotal);
