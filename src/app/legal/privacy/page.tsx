    ...
    <article>
      ...
      <Section title="1. 収集する情報">
        ...
        <Ul>
          ...
          <li>
            <b>広告の表示</b>：iOSアプリの無料プランでは広告を表示しますが、<b>パーソナライズ（追跡）は行わず</b>、広告識別子（IDFA）を用いた個人の追跡やクロスアプリのトラッキングは行いません（第5条参照）
          </li>
          <li>
      ...
      <Section title="5. 広告について（iOSアプリ）">
        <Ul>
          <li>iOSアプリの無料プランでは、Google AdMobによるバナー広告およびリワード広告を表示します。</li>
          <li>
            表示する広告は<b>非パーソナライズ広告</b>です。利用者を個人として特定・追跡するための広告識別子（IDFA）は取得せず、<b>他社のアプリやWebサイトをまたいだトラッキングは行いません</b>。そのため、Appトラッキング透明性（ATT）の許可ダイアログも表示しません。
          </li>
