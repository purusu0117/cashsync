...
// 公開ランディングページ（未ログインでも見られる／Twitter等からの導線）。
// アプリ本体と同じ「感熱紙レシート」の世界観で作る。TestFlightベータへの導線を主役にする。
...
export default function LandingPage() {
  return (
    <main className="mx-auto min-h-full max-w-[560px] px-5 pb-16 pt-10 text-ink">
      {/* ヘッダー */}
      ...
      <section className="mt-10 space-y-4">
        ...
        {[
          ...
          {
            t: "QR決済の画面もOK",
            d: "PayPay・d払いなどの支払い/受け取り画面のスクショから、支出・収入も自動で判別して記録します。",
          },
          {
            t: "スクショはアプリ内で削除",
